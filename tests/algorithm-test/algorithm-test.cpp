...
TEST(EraseIf, WithVector)
{
    ...
    static_assert(!algo::details::is_associative_container_v<VecInt>, "");
...
TEST(EraseIf, WithMap)
{
    ...
    static_assert(algo::details::is_associative_container_v<MapInt>, "");
    MapInt map{
        {1, 2},
        {2, 13},
        {3, 37},
...
TEST(EraseIf, WithStdList)
{
    ...
    static_assert(!algo::details::is_associative_container_v<ListString>, "");
...
TEST(EraseIf, WithStdSet)
{
    ...
    static_assert(algo::details::is_associative_container_v<SetString>, "");
